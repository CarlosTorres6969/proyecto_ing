            ...
            <div>
              ...
              {selectedVariante && (
                <div className="mt-4 flex items-baseline gap-3">
                  <span className="text-3xl font-bold">${precioActual?.toFixed(2)}</span>
                  {precioOriginal && (
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                <button
                  ...
                  className="flex-1 rounded-full bg-primary py-3 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90 disabled:opacity-50"
                >
                  {addingToCart ? 'Agregando...' : 'Agregar al carrito'}
                </button>
                <Link
                  href="/carrito"
                  className="rounded-full border border-border py-3 text-center text-sm font-medium transition-colors hover:bg-secondary sm:px-8"
                >
                  Ver carrito
                </Link>
              </div>
