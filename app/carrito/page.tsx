        ...
        <main className="flex-1">
          <div className="mx-auto max-w-7xl px-4 py-16 text-center sm:px-6 lg:px-8">
            ...
            <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Link href="/auth/login" className="rounded-full bg-primary px-8 py-3 text-sm font-medium text-primary-foreground">
                Iniciar sesion
              </Link>
              <Link href="/auth/registro" className="rounded-full border border-border px-8 py-3 text-sm font-medium">
                Crear cuenta
              </Link>
            </div>
          </div>
            ...
            <div className="mt-8 grid gap-8 lg:grid-cols-3">
                      ...
                      >
                        ...
                        <div className="flex flex-1 flex-col">
                          <div className="flex items-start justify-between">
                            ...
                            <p className="font-semibold">${(precioUnitario * item.cantidad).toFixed(2)}</p>
                          </div>
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-24 rounded-lg border border-border bg-card p-6">
                  ...
                  <Link
                    href="/checkout"
                    className="mt-6 block w-full rounded-full bg-primary py-3 text-center text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90"
                  >
